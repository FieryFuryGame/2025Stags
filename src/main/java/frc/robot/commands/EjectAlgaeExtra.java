...
public class EjectAlgaeExtra extends Command {
    ...
    public EjectAlgaeExtra(EndEffectorSimExtra effectorSim, ExtraDriver drivetrain, EndEffector effector, BargeController bargeController) {
